...
- Added release verification guidance for clean SSH reinstalls, package-version checks, and installed-tree checks before claiming a remote plugin release works.
