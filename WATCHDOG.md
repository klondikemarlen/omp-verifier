...
After every changed turn, run `node ~/.omp/plugins/node_modules/omp-verifier/bin/omp-verifier.js automatic` with `bash`. It emits one JSON array of automatic results:
