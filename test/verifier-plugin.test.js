...
assert.match(shippedWatchdog, /explicitly names a required check, invariant, or release condition/);
...
assert.match(shippedWatchdog, /Start from Gold/);
assert.match(shippedWatchdog, /Report `PASS`, `FAIL`, or `BLOCKED` from observed evidence/);
